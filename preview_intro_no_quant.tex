...
Rather than scoring units one at a time and aggregating the results, the approach taken
here treats the compression configuration of the full network as the object to be optimized,
...
limitation that motivates the proposed approach.

The second part presents the contribution and is composed of two chapters.
Chapter~4 describes the proposed framework: the parameterization of the structural
units subject to search, the budget model, the surrogate evaluation metric,
