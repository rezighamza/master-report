...
% Use square brackets for author-year citations, e.g. [Vaswani et al., 2017].
...
\begin{document}
	...
	\input{00-Page-de-garde-pruning}

	\pagenumbering{roman}
	%\include{front_matter/note}

	\input{02-Remerciements}
	\input{03-Resume-pruning}
	...
	\listoftables
	\clearpage
	\input{front_matter/abbreviations_pruning_only}
	\clearpage
	%\listofalgorithms
	...
	\input{05.1-Intro-pruning}

	\include{chapters/foundations_pruning_only}
	\include{sections/compression/neural_network_pruning}
%	\include{sections/compression/related_work_pruning_only}4
	\include{sections/compression/related_work_pruning_only_Unstructured}
	\include{sections/compression/related_work_pruning_only_Structured}
	\include{chapters/conclusion_pruning_only}
	\printbibliography[title={Bibliographie},heading=bibintoc]
	\printbibliography[title={Webographie},heading=bibintoc,keyword=web]
