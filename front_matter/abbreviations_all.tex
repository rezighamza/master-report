...
\acro{AdaLoRA}{Adaptive Budget Allocation via Low-Rank Adaptation}
\acro{AE}{Autoencoder}
...
\acro{DoRA}{Weight-Decomposed Low-Rank Adaptation}
\acro{DyLoRA}{Dynamic Low-Rank Adaptation with Flexible Rank Selection}
...
\acro{EXPthree}[EXP3]{Exponential-weight algorithm for Exploration and Exploitation}
...
\acro{GaLore}{Gradient Low-Rank Projection}
...
\acro{MAPElites}[MAP-Elites]{Multi-dimensional Archive of Phenotypic Elites}
...
\acro{PiSSA}{Principal Singular Values and Vectors Adaptation}
\acro{PPL}{Perplexity}
\acro{PTQ}{Post-Training Quantization}

\acro{QAT}{Quantization-Aware Training}
\acro{QNLI}{Question Natural Language Inference}
\acro{QuaRot}[QuaRot]{Quantization via Weight Rotation}

\acro{ReLU}{Rectified Linear Unit}
\acro{RMSNorm}[RMSNorm]{Root Mean Square Normalization}
\acro{RNN}{Recurrent Neural Network}
\acro{rsLoRA}[rsLoRA]{Rank-Stabilized LoRA}

\acro{SGD}{Stochastic Gradient Descent}
\acro{SoRA}{Sparse Low-Rank Adaptation}
...
\acro{STE}{Straight-Through Estimator}
\acro{SVD}{Singular Value Decomposition}

\acro{Tanh}[Tanh]{Hyperbolic Tangent}

\acro{VeRA}{Vector-Based Random Matrix Adaptation}
